...
public class HdfsUserManager extends AbstractUserManager {
   ...
   *
   * @return The password encryptor. Default to {@link Md5PasswordEncryptor} if
   ...
   * <
   * pre>
   * If the password value is not null password = new password else if user does
   * exist password = old password else password = &quot;&quot;
   * </pre>
   */
